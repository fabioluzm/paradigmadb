...
<body>
	<center>
		...
		<?php
			...
			echo '<center><h3 style="background-color: red; color: yellow; width:27% ">'.$_SESSION['username'].', tem a certeza que deseja eliminar a profissão?<br>Esta não poderá ser recuperada!</h3></center><br>';
		
			#Echo do butao de confirmação da eliminação do user que está dentro do $_GET['id']
			echo "<form action='professions-eliminar-db.php?id=".$_GET['id']."' method='POST'>
		...
		<form action="professions-alterar-eliminar.php" method="POST">
