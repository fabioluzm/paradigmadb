<?php
	...
	$sql = 'SELECT players.familyname AS familyname, professions.profname AS profname, professions.proflvl AS proflvl, professions.energy AS energy FROM players, professions
	WHERE players.idplayer = professions.idplayer ORDER BY profname ASC';
...
<body>
	<center>
		<header>
			<h1>Painel de Administração | Life Skills</h1>
			<br>
				...
				<?php 
					...
					foreach($resultado as $professions){ 
						echo "<tr align='center'>
								...
								<td><strong>".$professions['profname']."</strong></td>
