...
<body>
	<center>
		...
		<?php
			...
			echo '<center><h3 style="background-color: red; color: yellow; width:27% ">'.$_SESSION['username'].', tem a certeza que deseja eliminar o character?<br>Este não poderá ser recuperado!</h3></center><br>';
		
			#Echo do butao de confirmação da eliminação do user que está dentro do $_GET['id']
			echo "<form action='characters-eliminar-db.php?id=".$_GET['id']."' method='POST'>
		...
		<form action="characters-alterar-eliminar.php" method="POST">
