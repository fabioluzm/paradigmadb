...
<body>
	<center>
		<header>
			<h1 align="center">Painel de Administração | Character</h1>
		...
		<section>
			...
			<form align="center" action="characters-inserir-db.php" method="POST">
				
				<label><b>Nome do Character:</b></label><br>
					<input type="text" name="charname" placeholder="      Nome do character"  / required><br><br>
