<?php
	...
	#comando sql para a eliminação de dados da tabela players
	$sql="DELETE FROM players WHERE idplayer =".$_GET['id'];
...
<body>
	<?php
		if ($query->rowCount() > 0) {
			...
			#echo retornado caso a familia seja eliminada
			echo '<center><h3 style="background-color: green; color: white; width:16% ">Familia eliminada com sucesso!</h3></center>';
			...
			echo '<center><h3 style="background-color: red; width:16% ">Erro na eliminação da Familia!</h3></center><br>';	
		}
	?>
	<br><br><br>
